...
#define MQTT_DEVICEID "d:joc771:mkr1010:3c610516400c"
...
void mqtt_init();
//mqtt send
void mqtt_send(float,const char*,float,const char*,float,const char*, float,const char*, float,const char*);
...
if (sound_value > 300 && door_state == 1){
  buzzer_state=1;
  }
  ...
  sound_max = sound_value_max(sound_max,sound_value);
  //test
...
//  Serial.println(temperature_value);
  ...
  alarm_counter = fall_alarm_monitor(sound_max,humidity_value,temperature_value,alarm_counter_start,alarm_counter,clock_sec,clock_min);
  //test
...
//  Serial.println(sound_max);
  //MQTT send data
  mqtt_send(door_state,"door",sound_value,"sound",temperature_value,"temperature", humidity_value, "humidity", buzzer_state,"buzzer");
//mqtt_send(sound_value,"sound value");
//  mqtt_send(temperature_value,"temperature");
...
void mqtt_send(float send_data, const char* send_name,float send_data1, const char* send_name1,float send_data2, const char* send_name2, float send_data3, const char* send_name3, float send_data4, const char* send_name4){
  mqtt.loop();
  ...
  if (isnan(send_data)) {
    ...
    status[send_name3] = send_data3;
    status[send_name4] = send_data4;
